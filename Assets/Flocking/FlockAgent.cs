...
public class FlockAgent : MonoBehaviour
{
    ...
    private BalloonCounter balloonCounter;
    ...
    private void Start()
    {
        balloonCounter = FindFirstObjectByType<BalloonCounter>();
        if (rb.linearVelocity == Vector3.zero)
        {
            Vector3 dir = transform.forward;
            dir.y = 0;
            rb.linearVelocity = dir.normalized * manager.MinSpeed;
        }
    }
